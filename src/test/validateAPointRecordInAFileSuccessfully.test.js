const { expectedMessagesTC001 } = require('../data/messages/auxiliaryMessages'),
  { findAndSplitLine, readFileAndSeparateByLine } = require('../utils/functionFiles'),
  { searchFileData, dataTC001 } = require('../data/searchFile.data'),
  { assert } = require('chai')

describe('Teste em arquivos de ponto sem a busca binária', () => {
  it(`[TC-002] - Deve validar um registro de ponto no arquivo ${searchFileData.fileName} com sucesso`, () => {
